...
/**
 * ImageTerm class represents an immutable Narsese image term, that is, any term composed of one or
 * more other terms and which support any of the term and statement connectors, see
 * {@link Connector}.
 * <p>
 ...
 */
@ProviderType
public interface ImageTerm extends Term
{
  /**
   * Returns the connector of this image term.
   *
   * @return the connector of this image term.
   */
  ImageConnector getConnector();

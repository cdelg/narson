...
final class OperationTermBuilderImpl implements OperationBuilder
{
  private final Narsese narsese;
  private final String name;
  private final List<Term> terms = new ArrayList<>();

  public OperationTermBuilderImpl(Narsese narsese, String name)
  {
  ...
  @Override
  public OperationTerm build()
  {
    return new OperationTermImpl(narsese, name, Collections.unmodifiableList(new ArrayList<>(terms)));
  }
}

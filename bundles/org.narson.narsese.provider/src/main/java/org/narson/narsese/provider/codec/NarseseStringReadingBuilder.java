...
final public class NarseseStringReadingBuilder implements NarseseReadingBuilder<String>
{
  private final Narsese narsese;

  public NarseseStringReadingBuilder(Narsese narsese)
  {
  ...
  @Override
  public Function<String, List<Sentence>> toSentences()
  {
    return in -> {
  ...
  @Override
  public Function<String, Sentence> toSentence()
  {
    return in -> {
  ...
  @Override
  public Function<String, Stream<Sentence>> toStream()
  {
    return in -> {
